  ...
  return (
    <div className="ownLands">
      <div className="ownLands__content">
        ...
        <p>
          You may produce digital assets (also known as Non-Fungible Tokens, or
          NFTs) as a player, submit them to the marketplace, and then use The
          World Creator’s drag-and-drop functionality to construct new gaming
