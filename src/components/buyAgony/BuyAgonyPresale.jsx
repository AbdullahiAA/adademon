    ...
    <section className="buyAgonyPresale">
      <div className="buyAgonyPresale__howTo">
        ...
        <ol>
          ...
          <li>
            Go to the sale page for ADA Demon Seeds and <b>copy the Address</b>
          </li>
        </ol>
      </div>
      ...
      <div className="buyAgonyPresale__middle">
        <div className="buyAgonyPresale__tokenSale">
          ...
          <p>
            ...
            making purchases in the game and also be saved up as over time, the
            value of Agony will increase. As Presale holders, you get to be the
            first to enjoy this.
          </p>
